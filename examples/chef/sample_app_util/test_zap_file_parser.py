...
class TestZapFileParser(unittest.TestCase):
    ...
    def test_generate_hash(self):
        ...
        self.assertEqual(hash_string, "TKibkCJvCj", "Hash is incorrectly generated.")
    ...
    def test_generate_name(self):
        ...
        self.assertEqual(name, "rootnode_dimmablelight_TKibkCJvCj", "Name incorrectly generated.")
